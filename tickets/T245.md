...
## GOAL
Phase 1 gameplay upgrade ticket T245.
...
## ACTIONS
WRITE Assets/Scripts/PetController.cs <<<EOF
using System;
...
EOF
WRITE Assets/phase1-block/T245.txt <<<EOF
Phase1 playable UI/core loop controller upgraded
EOF
